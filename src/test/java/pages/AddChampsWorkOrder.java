...
public class AddChampsWorkOrder extends BaseTest {
	...
	public String getSuccessMessage() {
		return wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(loc.getProperty("ChampAddedMessage"))))
				.getText();
	}

	// Method to get the error message (assuming the same element as success
	// message)
	public String getErrorMessage() {
		return wait.until(
				ExpectedConditions.visibilityOfElementLocated(By.xpath(loc.getProperty("ChampDuplicateMessage"))))
				.getText();
	}
	...
	public void navigateToWorkOrderMenu() {
