...
//	((JavascriptExecutor) driver).executeScript("arguments[0].click();", btn_More);
	...
	public void clickOnbtn_DownloadProofofwork() {
		...
		wait.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath(loc.getProperty("OverlayElement"))));

		wait.until(ExpectedConditions.elementToBeClickable(By.xpath(loc.getProperty("btn_DownloadProofofwork"))))
				.click();

		// ((JavascriptExecutor) driver).executeScript("arguments[0].click();",
		// btn_DownloadProofofwork);
	}
	...
	public void clickOnbtn_NextPage() {
		WebElement clickOn_NextButton = wait
				.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(loc.getProperty("btn_NextPage"))));
