...
public class WithdrawCredit extends BaseTest {
	...
	public void enterEmail(String Email) {
		InputPhoneOrEmail = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath(loc.getProperty("InputPhoneOrEmail"))));
	...
	public void enterOtp(String Otp) {
		InputVerificationCode = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath(loc.getProperty("InputVerificationCode"))));
	...
	public void enterBankAccount(String BankAccountNumber) {
		InputBankAccount = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath(loc.getProperty("InputBankAccount"))));
	...
	public void enterBankAccountConfirm(String BankAccountNumberConfirm) {
		InputBankAccountConfirm = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath(loc.getProperty("InputBankAccountConfirm"))));
	...
	public void enterAccountHolderName(String AccountHolderName) {
		InputAccountHolderName = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath(loc.getProperty("InputAccountHolderName"))));
	...
	public String getPaymentStatus() {
		return wait
				.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(loc.getProperty("ConfirmPaymentStatus"))))
				.getText();
	}
	...
	public String getCreditStatus() {
		return wait
				.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(loc.getProperty("ConfirmCreditStatus"))))
				.getText();
	}
	...
	public String getCreditTypeTask() {
		return wait.until(
				ExpectedConditions.visibilityOfElementLocated(By.xpath(loc.getProperty("ConfirmCreditTypeTask"))))
				.getText();
	}

	// Method to get the Success message
	public String getSuccessMessage() {
		return wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(loc.getProperty("SuccessMessage"))))
				.getText();
	}

	// Method to get the error message for an invalid UPI
	public String getErrorMessageForInvalidUpi() {
		return wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(loc.getProperty("InvalidUpi"))))
				.getText();
	}
	...
	public String getErrorMessageForInvalidBankAccountNumber() {
		return wait.until(
				ExpectedConditions.visibilityOfElementLocated(By.xpath(loc.getProperty("InvalidBankAccountNumber"))))
				.getText();
	}

	// Method to get the error message for Invalid IFSC code
	public String getErrorMessageForInvalidIFSCcode() {
		return wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(loc.getProperty("InvalidIFSCcode"))))
				.getText();
	}

	// Method to get the error message for Short IFSC code
	public String getErrorMessageForShortIFSCcode() {
		return wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(loc.getProperty("ShortIFSCcode"))))
				.getText();
	}

	// Method to get the error message for Invalid Account Holder name
	public String getErrorMessageForInvalidName() {
		return wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(loc.getProperty("InvalidName"))))
				.getText();
	}

	// Method to get the error message for Short Account Holder name
	public String getErrorMessageForShortName() {
		return wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(loc.getProperty("ShortName"))))
				.getText();
	}

	public void navigateToBankPopup() {
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(loc.getProperty("BankPopup"))));
	}
