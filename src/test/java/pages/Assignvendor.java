...
public class Assignvendor extends BaseTest {
	...
	public void clickOn_location() {
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(loc.getProperty("click_location")))).click();
	}

	public void enterDate(String Date) {
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(loc.getProperty("txt_date")))).sendKeys(Date);
	}

	public void clickOn_Starttime() {
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(loc.getProperty("click_Starttime")))).click();
	}
	...
	public void clickOn_Endtime() {
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(loc.getProperty("click_Endtime")))).click();
	}

	public void clickOnSelect_Endtime() {
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(loc.getProperty("select_Endtime")))).click();
	}

	public void clickOnbtn_Addbilling() {
		WebElement btn_Addbilling = wait
				.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(loc.getProperty("btn_Addbilling"))));
	...
	public void clickOnbtn_SeeSummary() {
		WebElement SeeSummary_btn = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath(loc.getProperty("btn_SeeSummary"))));
		JavascriptExecutor jsExecutor = (JavascriptExecutor) driver;
		jsExecutor.executeScript("arguments[0].click();", SeeSummary_btn);
	}

	public void clickOnbtn_SubmitForApproval() {
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(loc.getProperty("btn_approval")))).click();
	}
	...
	public void clickOn_AssignVendor() {
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(loc.getProperty("Assign_vendor")))).click();
	}

	public String get_MessageForWorkorderAddedSuccessfully() {
		return wait
				.until(ExpectedConditions
						.visibilityOfElementLocated(By.xpath(loc.getProperty("message_workorderaddedsuccessfully"))))
				.getText();
